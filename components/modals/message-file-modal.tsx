...
export default function MessageFileModal() {
  ...
  /**
   * The `onSubmit` function is an asynchronous function that sends a POST request to a specified API
   * endpoint with form values and resets the form if successful.
